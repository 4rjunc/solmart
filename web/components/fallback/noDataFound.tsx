...
export default function MartNoItemsFound({
  ...
  description = "We couldn't find any matching products. Try adjusting your search or browse our categories.",
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] p-4 text-center rounded-lg">
      ...
      {actionLabel && onAction && (
        <Button onClick={onAction} variant="outline" className="bg-white hover:bg-gray-100">
          {actionLabel}
        </Button>
      )}
    </div>
